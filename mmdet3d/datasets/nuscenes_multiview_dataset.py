...
class NuScenesMultiViewDataset(Custom3DDataset):
    ...
    def __init__(self,
        ...
        self.with_box2d = True
        self.data_root = '/opt/data/private/codeN1/mmdetection3d/data/nuscenes/'
        self.nusc = NuScenes(version='v1.0-trainval', dataroot=self.data_root, verbose=False)
        # self.data_root = '/opt/data/private/codeN1/BEVDet/data/nuscenes-mini/'
