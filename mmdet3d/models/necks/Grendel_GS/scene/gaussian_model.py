...
import torch
import numpy as np
from ...Grendel_GS.utils.general_utils import inverse_sigmoid, get_expon_lr_func, build_rotation
from torch import nn
import os
from ...Grendel_GS.utils.system_utils import mkdir_p
from plyfile import PlyData, PlyElement
from ...Grendel_GS.utils.sh_utils import RGB2SH
from simple_knn._C import distCUDA2
from ...Grendel_GS.utils.graphics_utils import BasicPointCloud
from ...Grendel_GS.utils.general_utils import strip_symmetric, build_scaling_rotation
import mmdet3d.models.necks.Grendel_GS.utils.general_utils as utils
...
class GaussianModel:
    ...
    def create_from_pcd(self, pcd : BasicPointCloud, spatial_lr_scale : float):
        ...
        fused_point_cloud = pcd[..., 0:3].float()# It is not contiguous
        fused_point_cloud = fused_point_cloud.contiguous()# Now it's contiguous
        # fused_color = RGB2SH(torch.tensor(np.asarray(pcd.colors)).float().cuda())
        fused_color = RGB2SH(pcd[..., 3:6].float())
        ...
        dist2 = torch.clamp_min(distCUDA2(pcd[..., 0:3].float().cuda()), 0.0000001)
