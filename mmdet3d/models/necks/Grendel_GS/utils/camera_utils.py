...
from ...Grendel_GS.scene.cameras import Camera
import numpy as np
from ...Grendel_GS.utils.general_utils import PILtoTorch, get_args, get_log_file
import mmdet3d.models.necks.Grendel_GS.utils.general_utils as utils
from tqdm import tqdm
from ...Grendel_GS.utils.graphics_utils import fov2focal
import time
...
def cameraList_from_camInfos(cam_infos, args):
    ...
    for id, c in tqdm(enumerate(cam_infos), total=len(cam_infos), disable=(utils.LOCAL_RANK != 0)):
        camera_list.append(loadCam(args, id, c, decompressed_image=decompressed_images[id], return_image=False))
