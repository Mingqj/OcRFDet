...
class MyMultiScaleDeformableAttention(BaseModule):
    ...
    @deprecated_api_warning({'residual': 'identity'},
                            cls_name='MyMultiScaleDeformableAttention')
    def forward(self,
                query,
                key=None,
                value=None,
        ...
        # print(value.shape, (spatial_shapes[:, 0] * spatial_shapes[:, 1]).sum(), num_value)
